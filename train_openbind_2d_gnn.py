# =============================================================================
# MODULE: train_openbind_2d_gnn.py
# PURPOSE: Matched 2D molecular GNN training and evaluation pipeline.
...
from model.ligand_gnn import Ligand2DGNN  # Import selected classes or functions from the named dependency.
...
def build_model(args):  # Define this callable; its indented block implements the documented operation.
    """Construct the chemistry-only 2D atom-and-bond GNN."""
    return Ligand2DGNN(  # Return this computed tensor, metric, object, or collection to the caller.
...
def architecture_report(args, parameter_count):  # Define this callable; its indented block implements the documented operation.
    """Record the exact representation and dimensions used by the 2D GNN."""
    return {  # Return this computed tensor, metric, object, or collection to the caller.
...
def main() -> None:  # Define this callable; its indented block implements the documented operation.
    """Run the fixed 2D molecular graph model; no model selector is required."""
    run_cli(fixed_model="2d_gnn")
