# =============================================================================
# MODULE: train_openbind_3d_gnn.py
# PURPOSE: Matched crystallographic distance-GNN training and evaluation pipeline.
...
from model.ligand_3d_gnn import Ligand3DGNN  # Import selected classes or functions from the named dependency.
...
MODEL_LABELS = {"3d_gnn": "Crystallographic 3D distance GNN"}
...
def build_model(args):  # Define this callable; its indented block implements the documented operation.
    """Construct the crystallographic distance-RBF GNN."""
    return Ligand3DGNN(  # Return this computed tensor, metric, object, or collection to the caller.
...
def architecture_report(args, parameter_count):  # Define this callable; its indented block implements the documented operation.
    """Record the exact representation and dimensions used by the 3D GNN."""
    return {  # Return this computed tensor, metric, object, or collection to the caller.
...
def main() -> None:  # Define this callable; its indented block implements the documented operation.
    """Run the fixed 3D distance graph model; no model selector is required."""
    run_cli(fixed_model="3d_gnn")
